...
See [Content Packs & Registries](../content-packs-and-registries/) for the concrete registration model.
...
See [Asset Profiles & Fallbacks](../asset-profiles-and-fallbacks/) for the detailed behavior and API surface.
...
See [Diagnostics & Compatibility](../diagnostics-and-compatibility/) for the concrete compatibility layers.
...
See [Patching Guide](../patching-guide/) for the patching workflow.
...
See [Persistence Guide](../persistence-guide/) for the full data model.

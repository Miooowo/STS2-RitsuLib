---
title: "Asset Profiles & Fallbacks"
---
...
If those assets are backed by custom Godot scenes, remember that scene roots and scripted child nodes often need mod-local wrapper classes for stable editor binding. See [Godot Scene Authoring](../godot-scene-authoring/).

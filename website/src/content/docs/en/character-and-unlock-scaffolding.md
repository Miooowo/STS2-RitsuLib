---
title: "Character & Unlock Templates"
---
...
Detailed fallback rules are in [Asset Profiles & Fallbacks](../asset-profiles-and-fallbacks/). Detailed timeline and progression semantics are in [Timeline & Unlocks](../timeline-and-unlocks/). For wrapping scene scripts (visuals, rest sites, energy orbs), see [Godot Scene Authoring](../godot-scene-authoring/).
...
Character models follow the same fixed `ModelId.Entry` rule as all other content (see [Content Authoring Toolkit](../content-authoring-toolkit/)).
